...
from .parameter import ParamInfo, is_keyword, is_positional, is_variadic
...
def make_args_from_param_infos_recursive(
    ...
    def traverse(
        ...
        if not node.children:
            ...
            arg = Arg(
                name=Name(long=node.data.name.replace("_", "-")),
